...
<html lang="en">
  <head>
    <title>Sistem Informasi &mdash; Aspirasi Mahasiswa</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo"><a href="index.html">LAMA</a></div>
          <div>
          ...
          <div class="ml-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block">
                <li class="cta"><a href="#contact-section" class="nav-link"><span class="rounded border border-primary">Mulai</span></a></li>
              </ul>
            </nav>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-4 mr-auto" data-aos="fade-up">
            <h1>Layanan Aspirasi Mahasiswa.</h1>
            <p class="mb-5">Keluarkan semua ide dan pemikiranmu untuk sebuah perubahan di lingkungan Universitas.</p>
              <p><a href="#contact-section" class="btn btn-outline-light py-3 px-5">Get Started</a></p>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="image-absolute-box" >
              ...
              <img src="{{asset('assets/images/about_1.jpg')}}" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="site-section section-2" id="work-section">
      ...
      <div class="owl-carousel nonloop-block-13">
          <a class="work-thumb" href="{{asset('assets/images/about_1.jpg')}}" data-fancybox="gallery">
            <div class="work-text">
          ...
          <a class="work-thumb" href="{{asset('assets/images/slide_1.jpg')}}"  data-fancybox="gallery">
            <div class="work-text">
              <h3>Work Name Here</h3>
          ...
          <a class="work-thumb" href="{{asset('assets/images/slide_2.jpg')}}"  data-fancybox="gallery">
            <div class="work-text">
              <h3>Work Name Here</h3>
          ...
          <a class="work-thumb" href="{{asset('assets/images/slide_3.jpg')}}"  data-fancybox="gallery">
            <div class="work-text">
              <h3>Work Name Here</h3>
          ...
          <a class="work-thumb" href="{{asset('assets/images/slide_4.jpg')}}"  data-fancybox="gallery">
            <div class="work-text">
              <h3>Work Name Here</h3>
